...
import { UseExampleExample } from '../__docz__/components/UseExampleExample';
...
<h5 style={{color: "red", background: "yellow"}}>&nbsp;OR <small>(choose return type, delete others)</small></h5>
...
export function UseExampleExample() {
